        ...
        <div class="row align-items-center gy-4">
            <div class="col-lg-7">
                ...
                <div class="row g-4 mt-4 stagger">
                    <div class="col-md-4">
                        <div class="card p-4 card-soft h-100 tilt-card">
            ...
            <div class="col-lg-5">
                <div class="card feature-card p-4 h-100 shadow-sm tilt-card">
                    <h3 class="h5 mb-3">Research Philosophy</h3>
                    <ul class="list-unstyled text-muted">
                        <li class="mb-3"><strong>Scientific Excellence:</strong> Rigorous methods and peer-reviewed work.</li>
